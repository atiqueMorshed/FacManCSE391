      ...
      <div class="height150"></div>
        <div class="login-card"><img class="profile-img-card" src="assets/img/avatar_2x.png">
            ...
            <form class="form-signin" action="AdminLogin.php" method="post">
                ...
                <input class="form-control" type="email" name="AdminEmail" id="inputEmail" required="" placeholder="Email address" autofocus=""  pattern="[a-z0-9]{3,15}@[a-z]{5}\.[a-z]{1,3}">
                <input class="form-control" type="password" name="AdminPassword" id="inputPassword" required="" placeholder="Password" pattern=".{8,}">
                <button type="submit" name="AdminLogin" value="Admin" class="btn btn-primary btn-block btn-lg btn-signin" style="background-color: rgba(33,37,41,0.81)">Login</button>
            </form>
            <?php
              if (isset($LoginMsg)) {
                echo $LoginMsg;
        ...
        <!-- <p class="text-center text-danger" name="error"> <?php echo $LoginMsg ?> </p> -->
    </div>
    </div>
