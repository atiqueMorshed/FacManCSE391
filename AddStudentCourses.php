              ...
              <div class="collapse navbar-collapse" id="navbarResponsive">
                  <ul class="nav navbar-nav ml-auto">
                      ...
                      <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#">Login</a>
                          <div class="dropdown-menu" role="menu"><a class="dropdown-item" role="presentation" href="FacultyLogin.php">Faculty</a><a class="dropdown-item" role="presentation" href="StudentLogin.php">Student</a><a class="dropdown-item" role="presentation" href="AdminLogin.php">Admin</a></div>
                      </li>
                  </ul>
              </div>
          </div>
